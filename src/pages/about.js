 ...
 * @LastEditTime: 2022-01-16 18:58:04
 * @FilePath: /shirley/src/pages/about.js
 */
import React from "react";

import { Header } from "../components";
import image from "../images/about-2.jpeg";
        ...
        <main>
            ...
            <div className="About_page flex-col">
                <div className="About_main1 flex-col">
                    ...
                    <span className="About_info5">{`Hi, my name is Di Yue (Shirley) and I'm a self taught UI designer and illustrator. Every single project.  I have learnt a lot of the processes, concepts and theories of UX/UI through attending workshops, reading books, blogs and applying these to projects in my spare time and at work. I am very much a big-picture thinker and enjoy working on products end to end, from ideation all the way to development.
When I'm not designing or drawing you can find me cooking or singing.`}</span>
                    <div className="About_wrap4 flex-col">
                        <a href={null} download={"Resume_Di Yue"}>
                    ...
                    <div className="About_wrap7">
                        <div className={"About_icon-container"}>
                            <img
                                ...
                                onClick={() =>
                                    window.open(
                                        "https://www.linkedin.com/in/diyue-uidesigner/"
                                    )
                                }
                                src={icon1}
                            />
                        ...
                        <div
                            title={"+610410918668"}
                            className={"About_icon-container"}
                        >
                            <img
                                title={"+610410918668"}
